...
import './CardCelulares.css'

function CardCelulares() {
  return (
    <><div className='titulo'><h1>Venta de Celulares 📲🤩</h1></div>
    <div className='container-cell'>
        <div className="card" id='card-cell'>
          <img src="/images/Productos/Celulares/samsung.jpg" className="card-img-top" alt="..." />
          <div className="card-body">
              <h5 className="card-title">Samsung Galaxy S21</h5>
              <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/OFERTA Tablet Uniq 10.1.jpg" className="card-img-top" alt="..." />
            <div className="card-body">
                  <h5 className="card-title">OFERTA Tablet Uniq 10.1</h5>
                  <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/TECNO SPARK 10C.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
                <h5 className="card-title">TECNO SPARK 10C</h5>
                <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/TECNO SPARK Go 2023.jpg" className="card-img-top" alt="..." />
            <div className="card-body">
                <h5 className="card-title">TECNO SPARK Go 2023</h5>
                <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/Teléfonos Xiaomi I.jpg" className="card-img-top" alt="..." />
            <div className="card-body">
                <h5 className="card-title">Teléfonos Xiaomi I</h5>
                <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/Teléfonos Xiaomi II.jpg" className="card-img-top" alt="..." />
            <div className="card-body">
                <h5 className="card-title">Teléfonos Xiaomi II.</h5>
                <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
        ...
        <div className="card" id='card-cell'>
            <img src="/images/Productos/Celulares/Teléfonos Xiaomi III.jpg" className="card-img-top" alt="..." />
            <div className="card-body">
                <h5 className="card-title">Teléfonos Xiaomi III</h5>
                <p className="card-text">‼️Los teléfonos ya están en Cuba‼️ <br />                
                ✅ REGALAMOS: cable, cargador, audífonos, cover y mica. <br />
                ✅ Entregas en La Habana en menos de 24 horas. <br />
                ✅ Demás provincias máximo 5 días.</p>
