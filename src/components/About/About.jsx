  ...
  return (
    ...
    <div className='contenedor-about container-fluid' id='About'> 
        ...
        <div className='contenedor-acerca '>
          <h2>"Agencias de servicios para toda Cuba CubanoShop"</h2>
          <div className="redes">
        ...
        <div className="contenedor-info">
          ...
          <div className="info">
          <h2><i class="bi bi-send-check"></i>Domicilio </h2>
            <p>La Habana, Cuba · Cienfuegos, Cuba · Ciego de Ávila, Cuba · Matanzas, Cuba · Camagüey, Cuba</p>
          <h2><i class="bi bi-telephone-inbound"></i>Teléfono </h2>
          <p>+53 52990719 </p>
          <h2><i class="bi bi-envelope-at-fill"></i>Correo </h2>
          <p>
