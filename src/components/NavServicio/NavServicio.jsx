...
function NavServicio() {
  ...
  <nav className="navbar navbar-expand-lg navbar navbar-dark ">
    <div className="container-fluid">
      <a className="navbar-brand" href="https://linktr.ee/89MillasAgency" target='__blanck'><img className='icono' src='/images/icono.png' alt="" /></a>
        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li><a className="dropdown-item" href="/Electrodomestico">Electrodoméstico</a></li>
